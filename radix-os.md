...
<main class="page">
  ...
  <section class="hero">
    ...
    <h1>RADPx OS</h1>
    <p class="lead">
      RADPx OS is the Crimson 0.2.0 experimental package line for the POSIX-inspired kernel, x86 VM image track, embedded board ports, future SoC targets, and RADPx <code>.radpm</code> package metadata.
    </p>
  ...
  <section class="grid">
    <article class="card">
      ...
      <div class="links">
      <a class="link-card" href="docs/radix-os/0.2.0/api/"><strong>RADPx-OS API</strong><span>Kernel API, device tree, networking, compositor, and Pi Zero 2 W notes.</span></a>
      </div>
    </article>
